...
if(isset($_GET['task'])){
	...
	if($_GET['task']=='new'){?>
		<form method="post" class="form-stacked" action="form_submit.php?file=user&function=newUser&origin=user">
			<label for="name">Username</label>
			<input type="text" class="full" name="name" placeholder="username"/>
	...
	<?php }elseif($_GET['task']=='edit'){?>
			<form method="post" class="form-stacked" action="form_submit.php?file=user&function=update&origin=user">
			<label for="name">Username</label>
			<input type="text" class="full" name="name" value='<?php echo $data['form']['name'];?>'/>
			<label for="email">Email</label>
